...
if(isset($_POST['submit']))
{
  ...
  $sql = "INSERT INTO `books`(`id`, `name`, `author_name`, `price`, `quantity`, `created_at`, `publisher`) VALUES (NULL,'$Name','$Author','$Price','$Quantity','$Created','$Publisher')";
